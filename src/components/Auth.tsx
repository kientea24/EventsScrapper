...
const Auth = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    // Simulate login success - redirect to home page with signed in state
    navigate("/", { state: { isSignedIn: true } });
  };

  const handleSignup = (e: React.FormEvent) => {
    e.preventDefault();
    // Simulate signup success - redirect to email verification
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Join thousands discovering life-changing opportunities
          </p>
        </div>
        ...
        <Card className="bg-white/90 backdrop-blur-sm shadow-xl border border-purple-100">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Create your account or sign in to never miss an opportunity
            </CardDescription>
          </CardHeader>
          <CardContent>
